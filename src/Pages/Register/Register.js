                ...
                <div className='flex justify-center items-center'>
                    <div className="card w-96 bg-base-100 shadow-xl">
                        <div className="card-body">
                            <h2 className="text-center text-accent text-3xl font-bold">Register</h2>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input className='btn  text-white w-full max-w-xs mt-2' type="submit" value='SIGN UP' />
                            </form>
                            <p>Already have an account? <Link to='/login' className='pl-1 text-sm text-primary'>Login</Link></p>
                            <div className="divider">OR</div>
                            <button className="btn btn-accent text-white" onClick={handleGoogleSignIn}>SIGN IN WITH GOOGLE</button>
                        </div>
                    </div>
                </div>
            </div>
